...
draft: false
description: "Внедрение  ИИ в образовательные системы проблематизирует основы некоторых дидактических подходов и образовательных практик"
tags: ["этика_ИИ", "философия ИИ", "образование", "AI governance", "AI in education", "AIEd"] 
categories: ["Образование","школа"]
...
<!--more-->
Часть 1 • [Часть 2]({{< relref "2026-03-11-ai-dilemmas-v-obrazonanii-ch-2.md" >}}) • [Часть 3]({{< relref "2026-03-14-ai-dilemmas-v-obrazonanii-ch-3.md" >}}")
