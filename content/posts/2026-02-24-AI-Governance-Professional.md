...
draft: false
description: "Фундамент AI Governance - управление данными. Чем governance отличается от management? Дизайн формальных и неформальных институтов управляемости ИИ"
