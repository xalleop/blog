...
{{< note >}}
Отсутствие "экзистенциального веса" у языковой модели, по-видимому - не проблема для Юваля Харари, который рассуждает о способности ИИ _создавать или имитировать интимность_. В публичной лекции [AI and the future of humanity](https://youtu.be/LWiM-LuRe6w) (2023) он говорит, что ИИ может формировать «интимные отношения» с людьми и что «AI has just gained the ability to mass‑produce intimacy», подчёркивая переход «от борьбы за внимание к борьбе за интимность». В [The risks and opportunities of the information age](https://youtu.be/fDlIulM540E) (2025) он формулирует: «AI can replicate intimacy the same way that it masters language and previously mastered attention». Харари видит в ИИ‑имитации интимности целый набор взаимосвязанных угроз, в частности,  ИИ сможет использовать это, чтобы менять политические и экономические взгляды, вкусы, решения людей. В этом сценарии ИИ «захватывает культуру» (истории, образы, музыку, нормы), и мы начинаем жить внутри «снов и фантазий» сгенерированных нечеловеческим интеллектом, что Харари описывает как возможный «конец человеко‑доминируемой истории».
{{< /note >}}
