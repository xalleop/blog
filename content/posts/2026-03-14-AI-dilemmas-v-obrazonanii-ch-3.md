...
%% Дискурс о «допуске ИИ» в образование воспроизводит ту же структуру: есть тест на «человечность» текста (антиплагиат, стилистический анализ), есть тревога по поводу «невидимого чужого» (текст, который _выглядит_ как человеческий, но произведён машиной), есть потребность в надёжном маркере различения — и та же невозможность его установить.  %%
...
{{note info}}Вот здесь интересное : [Иллюзия консенсуса. Почему ИИ-агенты не станут нам друзьями](https://t.me/testuring/2179)

## LLM и перспектива проблематизации культурно-исторического подхода {{< /note >}}
